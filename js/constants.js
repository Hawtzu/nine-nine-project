...
const SKILL_INFO = {
    ...
    [SPECIAL_SKILLS.CHECKPOINT]: { name: 'Check Point', color: '#FF1493', textColor: '#FFFFFF', costKey: 'checkpoint', desc: 'Place checkpoint & destroy adjacent stones, or teleport back (also destroys)', jaDesc: '自分の位置にCheckpoint Tileを設置し周囲4方向の石を破壊。所有済みならテレポートし、再び周囲4方向の石を破壊。', image: 'assets/skills/Check point.png' },
